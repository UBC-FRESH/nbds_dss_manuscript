...
- [x] Phase 1 — Requirements alignment
  ...
  - [x] Task 1.2 — Reconfirm SF guide requirements (file formats, highlights, data policy)
    - [x] Subtask 1.2.1 — Confirm highlights must be a separate file in EM
    - [x] Subtask 1.2.2 — Confirm Option C data policy requirements
    - [x] Subtask 1.2.3 — Confirm AI policy for text vs. figures/graphical abstract
...
- [x] Phase 2 — Manuscript compliance updates
  ...
  - [x] Task 2.3 — Keywords and highlights alignment
  ...
  - [x] Task 2.4 — Data policy compliance (Option C)
    - [x] Subtask 2.4.1 — Confirm dataset deposit and add explicit dataset citation/link
    - [d] Subtask 2.4.2 — If data cannot be shared, add a clear reason statement (N/A: data shared)
  - [x] Task 2.5 — Appendix numbering and references
...
- [x] Phase 3 — Figures, tables, and assets
  - [ ] Task 3.1 — Figure file hygiene
    ...
    - [x] Subtask 3.1.3 — Confirm resolution/legibility and non-AI provenance
  - [x] Task 3.2 — Graphical abstract
    - [x] Subtask 3.2.1 — Verify size/readability at 5×13 cm
  - [x] Task 3.3 — Tables
    - [x] Subtask 3.3.1 — Ensure tables are cited, numbered, and editable

- [x] Phase 4 — Build and package
  - [x] Task 4.1 — Rebuild manuscript PDF
  - [x] Task 4.2 — Assemble submission package (LaTeX source, figures, highlights, GA)
  - [x] Task 4.3 — Final QA pass (spelling/grammar, references, checklist items)

- [x] Phase 5 — Portal submission prep
  - [x] Task 5.1 — Declarations tool docx (competing interests) ready to upload
  - [x] Task 5.2 — Corresponding author details (email, postal address, phone)
  - [d] Task 5.3 — APC funding/waiver decision documented
  - [x] Task 5.4 — Record submission ID/date after upload
